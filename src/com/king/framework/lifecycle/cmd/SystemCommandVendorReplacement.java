 ...
 * @version 1.0
 */
public class SystemCommandVendorReplacement extends SystemCommand{    
    public static char ID = 0x014;
    public static byte ARG_LIST = 00;
    public static byte ARG_ADD = 01;
    public static byte ARG_DEL = 02;
    public static byte ARG_RELOAD = 03;

    public SystemCommandVendorReplacement() {
        super();
    }

    public SystemResponse makeResponse(int result, List args) {
    	SystemResponseVendorReplacement response=new SystemResponseVendorReplacement(this,result, args);
        return response;
    }
    ...
    public Event getEvent() {
        ...
        return factory.newEvent(Event.TYPE_SYSTEM_VENDOR_REPLACE_RELOAD);
    }
}
