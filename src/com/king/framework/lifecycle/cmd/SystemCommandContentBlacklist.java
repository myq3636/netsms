 ...
 * @version 1.0
 */
public class SystemCommandContentBlacklist extends SystemCommand{    
    public static char ID = 0x011;
    public static byte ARG_LIST = 00;
    public static byte ARG_ADD = 01;
    public static byte ARG_DEL = 02;
    public static byte ARG_RELOAD = 03;

    public SystemCommandContentBlacklist() {
        super();
    }

    public SystemResponse makeResponse(int result, List args) {
    	SystemResponseContentBlacklist response=new SystemResponseContentBlacklist(this,result, args);
        return response;
    }
    ...
    public Event getEvent() {
        ...
        return factory.newEvent(Event.TYPE_CONTENT_BLACKLIST_RELOAD);
    }
}
