 ...
 * @version 1.0
 */
public class SystemCommandSenderBlacklist extends SystemCommand{    
    public static char ID = 0x00f;
    public static byte ARG_LIST = 00;
    public static byte ARG_ADD = 01;
    public static byte ARG_DEL = 02;
    public static byte ARG_RELOAD = 03;

    public SystemCommandSenderBlacklist() {
        super();
    }

    public SystemResponse makeResponse(int result, List args) {
    	SystemResponseSenderBlacklist response=new SystemResponseSenderBlacklist(this,result, args);
        return response;
    }
    ...
    public Event getEvent() {
        ...
        return factory.newEvent(Event.TYPE_SENDER_BLACKLIST_RELOAD);
    }
}
