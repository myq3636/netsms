 ...
 * @version 1.0
 */
public class SystemCommandRecipientBlacklist extends SystemCommand{    
    public static char ID = 0x012;
    public static byte ARG_LIST = 00;
    public static byte ARG_ADD = 01;
    public static byte ARG_DEL = 02;
    public static byte ARG_RELOAD = 03;

    public SystemCommandRecipientBlacklist() {
        super();
    }

    public SystemResponse makeResponse(int result, List args) {
    	SystemResponseRecipientBlacklist response=new SystemResponseRecipientBlacklist(this,result, args);
        return response;
    }
    ...
    public Event getEvent() {
        ...
        return factory.newEvent(Event.TYPE_RECIPIENT_BLACKLIST_RELOAD);
    }
}
