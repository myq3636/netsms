...
public class SizedScheduledExecutorService implements ScheduledExecutorService {
    ...
    private static SystemLogger log = SystemLogger.getSystemLogger(SizedScheduledExecutorService.class);
    ...
    protected boolean canScheduleOrExecute() {
        ...
        if (log.isTraceEnabled()) {
            log.trace("{} queue size: current={}, upper={}", new Object[]{this, size, queueSize});
        }
        return answer;
    }
    ...
    public String toString() {
        ...
        if (delegate.getThreadFactory() instanceof A2PThreadFactory) {
            String name = ((A2PThreadFactory) delegate.getThreadFactory()).getName();
