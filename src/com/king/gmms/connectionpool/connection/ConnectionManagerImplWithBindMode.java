 ...
 * @version 1.0
 */
public class ConnectionManagerImplWithBindMode
    implements ConnectionManager {

    private ConnectionPool connectionPool = null;
    private IndexStrategy strategy = null;

    public ConnectionManagerImplWithBindMode() {
        this(new IndexRandomStrategy());
    }

    public ConnectionManagerImplWithBindMode(IndexStrategy strategy) {
    ...
    public Session getSession() {
        ...
        if (index < connectionPool.getAvailableSize()) {
            for (int i = index; i < connectionPool.getAvailableSize(); i++) {
                ...
                if (connection != null &&
                    (connection.getBindMode().equals(BindMode.Transmitter)
