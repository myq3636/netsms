...
{
    private static SystemLogger logger = SystemLogger.getSystemLogger(CertificateValidator.class);
	...
	if (cert != null && cert instanceof X509Certificate) {
            ...
            try {
                ...
                if (certAlias == null) {
                    certAlias = "KingSMPP" + String.format("%016X", aliasCount.incrementAndGet());
