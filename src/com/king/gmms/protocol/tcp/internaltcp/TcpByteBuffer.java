...
public class TcpByteBuffer {
    ...
    public int read1ByteAsSignInt() throws NotEnoughDataInByteBufferException {
        int result = 0;
        int len = length();
        if (len >= SZ_BYTE) {
    ...
    public int remove1ByteAsSignInt() throws NotEnoughDataInByteBufferException {
        int result = read1ByteAsSignInt();
        removeBytesOnly(SZ_BYTE);
        return result;
    }
