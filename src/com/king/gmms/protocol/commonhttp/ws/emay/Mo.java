...
public class Mo  implements java.io.Serializable {
	 ...
	 * 
	 */
	private static SystemLogger log = SystemLogger.getSystemLogger(Mo.class);
    ...
    public Object getProperty(String propertyName){
		Method[] methods = Mo.class.getMethods();
		Object obj = null;
		try {
			...
			log.warn("get property " + propertyName + " error in Mo class !");
		}
		return obj;
	}
}
