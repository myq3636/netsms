...
public class CommonDeliveryReportQueryRESTUrlEncodeHttpHandler extends HttpHandler {
	
	private static SystemLogger log = SystemLogger
	.getSystemLogger(CommonDeliveryReportQueryRESTUrlEncodeHttpHandler.class);

	public CommonDeliveryReportQueryRESTUrlEncodeHttpHandler(HttpInterface hie) {
		super(hie);
	}
