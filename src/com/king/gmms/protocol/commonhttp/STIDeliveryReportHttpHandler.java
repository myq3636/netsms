...
public class STIDeliveryReportHttpHandler extends HttpHandler {
	private static SystemLogger log = SystemLogger
			.getSystemLogger(STIDeliveryReportHttpHandler.class);

	public STIDeliveryReportHttpHandler(HttpInterface hie) {
		super(hie);
	}
