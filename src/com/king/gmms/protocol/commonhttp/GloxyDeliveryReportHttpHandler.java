...
public class GloxyDeliveryReportHttpHandler extends HttpHandler {
	private static SystemLogger log = SystemLogger
			.getSystemLogger(GloxyDeliveryReportHttpHandler.class);

	public GloxyDeliveryReportHttpHandler(HttpInterface hie) {
		super(hie);
	}
	...
	public String makeResponse(HttpStatus hs, GmmsMessage message,
		...
		if (GmmsStatus.DELIVERED.getCode()== message.getStatusCode()) {
			return "success";
		}else {
			return "error";
		}
