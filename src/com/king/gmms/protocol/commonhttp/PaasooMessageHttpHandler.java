...
public class PaasooMessageHttpHandler extends HttpHandler {
	private static SystemLogger log = SystemLogger
			.getSystemLogger(PaasooMessageHttpHandler.class);

	public PaasooMessageHttpHandler(HttpInterface hie) {
		super(hie);
	}
	...
	public String makeRequest(GmmsMessage message, String urlEncoding,
		...
		for (HttpParam param : parameters) {
			...
			if ("senderAddress".equalsIgnoreCase(pval)) {
				...
				postData.append("&").append(param.getOppsiteParam())
						.append("=").append(urlEncode(message.getTextContent(), "UTF-8"));// message
