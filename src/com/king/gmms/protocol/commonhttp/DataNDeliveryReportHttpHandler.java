...
public class DataNDeliveryReportHttpHandler extends HttpHandler {
	private static SystemLogger log = SystemLogger
			.getSystemLogger(DataNDeliveryReportHttpHandler.class);

	public DataNDeliveryReportHttpHandler(HttpInterface hie) {		   
		super(hie);
	}
