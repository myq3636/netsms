...
public class EnterpriseMessageHttpHandler extends HttpHandler {
	private static SystemLogger log = SystemLogger.getSystemLogger(EnterpriseMessageHttpHandler.class);
	public EnterpriseMessageHttpHandler(HttpInterface hie){		
		super(hie);	
	}
	/**
