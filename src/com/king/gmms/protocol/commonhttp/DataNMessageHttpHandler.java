...
public class DataNMessageHttpHandler extends HttpHandler {
	private static SystemLogger log = SystemLogger
			.getSystemLogger(DataNMessageHttpHandler.class);	

	public DataNMessageHttpHandler(HttpInterface hie) {
		super(hie);
	}
	...
	public String makeRequest(GmmsMessage message, String urlEncoding,
		...
		String md5Pw = HttpUtils.encrypt(chlPwd+dataTime, "MD5");
		postData.append("&uid=").append(chlAccount)
		        .append("&pw=").append(md5Pw)
