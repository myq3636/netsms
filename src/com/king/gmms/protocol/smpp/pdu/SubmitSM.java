...
//    private ShortMessage shortMessage       = new ShortMessage(Data.SM_MSG_LEN);
    ...
    private TLVOctets messageType = new TLVOctets(Data.OPT_PAR_MESSAGETYPE, Data.OPT_PAR_MESSAGETYPE_NUM_MIN, Data.OPT_PAR_MESSAGETYPE_NUM_MAX); // 1-9
     ...
     * @throws PDUException
     */
    public void setBinShortMessage(byte[] byteData)
            throws NotEnoughDataInByteBufferException,
                   TerminatingZeroNotFoundException,
                   PDUException {
        shortMessage.setData(new SmppByteBuffer(byteData));
        setSmLength((short) byteData.length);
    }
     ...
     * @return byte[]
     */
    public byte[] getBinShortMessage() {
        return shortMessage.getData().getBuffer();
    }
    ...
    public void setMessagePayload(SmppByteBuffer value) {
    ...
    public void setCallbackNum(SmppByteBuffer value) {
    ...
    public void setCallbackNumAtag(SmppByteBuffer value) {
        callbackNumAtag.setValue(value);
    }

    public void setSourceSubaddress(SmppByteBuffer value) {
        sourceSubaddress.setValue(value);
    }

    public void setDestSubaddress(SmppByteBuffer value) {
    ...
    public SmppByteBuffer getMessagePayload()
            throws ValueNotSetException {
    ...
    public SmppByteBuffer callbackNum()
            throws ValueNotSetException {
    ...
    public SmppByteBuffer getCallbackNumAtag()
            throws ValueNotSetException {
        return callbackNumAtag.getValue();
    }

    public SmppByteBuffer getSourceSubaddress()
            throws ValueNotSetException {
        return sourceSubaddress.getValue();
    }

    public SmppByteBuffer getDestSubaddress()
            throws ValueNotSetException {
    ...
    public SmppByteBuffer getMessageType()
    		throws ValueNotSetException {
		return messageType.getValue();
	}

	public void setMessageType(SmppByteBuffer value) {
		messageType.setValue(value);
	}
