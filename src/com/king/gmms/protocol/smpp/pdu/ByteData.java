...
public abstract class ByteData extends SmppObject {
	...
	private static SystemLogger log = SystemLogger.getSystemLogger(ByteData.class);
    /**
    ...
    static {
        ...
        // set timezone just in case of DST
     ...
     *                      expected more data in
     *                      the buffer
     * @throws TerminatingZeroNotFoundException
     *                      the c-string in buffer
     *                      wasn't terminated with 0  zero
     * @see #getData()
     */
    public abstract void setData(SmppByteBuffer buffer)
            throws PDUException,
     ...
     */
    public abstract SmppByteBuffer getData()
     ...
     * @throws WrongLengthOfStringException thrown if the string is longer
     ...
     * @throws WrongLengthOfStringException thrown if the string is longer
     *                                      than the provided max length
     * @throws UnsupportedEncodingException the required encoding isn't
     *                                      supported
     */
