...
public class DeliverSM extends Request {
    ...
    public SmppByteBuffer getNetworkErrorCode()
            throws ValueNotSetException {
    ...
    public String debugString() {
        return new StringBuilder().append("(deliver: ").append(super.debugString())
                .append(getSourceAddr().debugString()).append(" ")
                .append(getDestAddr().debugString()).append(" ")
                .append(shortMessage.debugString()).append(" ")
                .append(debugStringOptional()).append(") ").toString();
    }
