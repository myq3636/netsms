...
public class TLVOctets extends TLV {
    private SmppByteBuffer value = null;
    ...
    public TLVOctets(short p_tag, SmppByteBuffer p_value)
            throws TLVException {
        super(p_tag);
        setValueData(p_value);
    }

    public TLVOctets(short p_tag, int min, int max, SmppByteBuffer p_value)
            throws TLVException {
        super(p_tag, min, max);
        setValueData(p_value);
    }
    ...
    public void setValue(SmppByteBuffer p_value) {
        if(p_value != null) {
            try {
    ...
    public SmppByteBuffer getValue()
            throws ValueNotSetException {
        if(hasValue()) {
            return value;
        }
