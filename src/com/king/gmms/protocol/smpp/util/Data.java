...
public class Data {
    ...
    // add for version smpp3.3 by Jesse Duan@King.com
    ...
    //King defined error code: Invalid ServiceTypeID
    public static final int ESME_RINVSERTYPID = 0x00000016;
    //King defined error code: Duplicate Message
    public static final int ESME_RDUPLICATEMSG = 0x00000017;
    ...
    // ### King defined optional parameters begin ###
    public static final short OPT_PAR_SERVICETYPEID = 0x1401;
    // ### King defined optional parameters end ###
    public static final short OPT_PAR_MESSAGETYPE = 0x1414;
    public static final int OPT_PAR_MESSAGETYPE_NUM_MIN = 1;
    public static final int OPT_PAR_MESSAGETYPE_NUM_MAX = 9;
    ...
    public static final int OPT_PAR_MSG_PAYLOAD_MIN = 0;
    ...
    public static final String ENC_ASCII = GmmsMessage.AIC_CS_ASCII;
    // Windows Latin-1
    ...
    // Sixteen-bit Unicode Transformation Format, big-endian byte order
    public static final String ENC_UTF16_BE = GmmsMessage.AIC_CS_UCS2;
    ...
    //change Queue_timeout from 10s to 5s.
    public static final long QUEUE_TIMEOUT = 500;
    public static final long ACCEPT_TIMEOUT = 5000;//accept timeout, setReceiveTimeout
