 ...
 * as a superclass except of classes in the <code>com.king.gmms.protocol.smpp.debug</code>
...
//    static protected Event event;
    ...
    /**
     * Debug tracing group for JmsReceiver & Transmitter classes.
     */
    public static final int DRXTX = 1;

    /**
     * Detailed debug tracing group for JmsReceiver & Transmitter classes.
     */
    public static final int DRXTXD = 2;

    /**
     * Event more detailed debug tracing group for JmsReceiver & Transmitter classes.
     */
...
//        event = new DefaultEvent();
        /*
        String dbgDir = "./log/";
        debug = new FileDebug(dbgDir,"smppServerDug.dbg");
        event = new FileEvent(dbgDir,"smppServerEvt.evt");
        debug.activate();
        event.activate();
        */
