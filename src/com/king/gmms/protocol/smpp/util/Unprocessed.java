...
public class Unprocessed {
     ...
     *
     * @see #hasUnprocessed
     * @see com.king.gmms.protocol.smpp.ReceiverBase#receivePDUFromConnection(Connection,Unprocessed)
     */
    private SmppByteBuffer unprocessed = new SmppByteBuffer();
     ...
     *
     * @see com.king.gmms.protocol.smpp.ReceiverBase#receiveTimeout
    ...
    public SmppByteBuffer getUnprocessed() {
        return unprocessed;
    }
