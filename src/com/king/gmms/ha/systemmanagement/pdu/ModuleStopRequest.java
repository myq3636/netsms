...
public class ModuleStopRequest extends SystemPdu {
	private static SystemLogger log = SystemLogger
			.getSystemLogger(ModuleStopRequest.class);

	public ModuleStopRequest() {
		if (header == null) {
			header = new SystemPduHeader();
		}
		header.setCommandId(this.COMMAND_MODULE_STOP_REQUEST);
	...
	public String toString() {
		return new StringBuffer("MODULE_STOP_REQUEST uuid:").append(
				uuid).append(",").append("timestamp:").append(timestamp)
				.toString();
	}
}
