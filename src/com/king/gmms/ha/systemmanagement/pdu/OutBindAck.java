...
public class OutBindAck extends SystemPdu {
    private static SystemLogger log = SystemLogger.getSystemLogger(OutBindAck.class);
    private int responseCode = -1;
	public OutBindAck(SystemPdu req) {
			super();
	        if (header == null) {
	            header = new SystemPduHeader();
	        }
	        header.setCommandId(this.COMMAND_OUT_BIND_ACK);
	...
	public String toString() {
        return new StringBuffer("OUT_BIND_ACK ").append(super.toString())
