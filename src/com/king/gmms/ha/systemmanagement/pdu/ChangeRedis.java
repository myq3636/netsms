...
public class ChangeRedis extends SystemPdu {
    private static SystemLogger log = SystemLogger.getSystemLogger(ChangeRedis.class);
	...
	public ChangeRedis() {
	        ...
	        header.setCommandId(this.COMMAND_CHANGEREDIS);
	...
	public String toString() {
        return new StringBuffer("CHANGEREDIS uuid:").append(uuid).append(",")
