...
public class ConnectionHttpConfirm extends SystemPdu {
    private static SystemLogger log = SystemLogger.getSystemLogger(ConnectionHttpConfirm.class);
    private String value = null;
    private String queryMethod = null;
    private int ssid = 0;
	public ConnectionHttpConfirm() {
	        if (header == null) {
	            header = new SystemPduHeader();
	        }
	        header.setCommandId(this.COMMAND_CONNECTION_HTTP_CONFIRM);
	...
	public String toString() {
        return new StringBuffer("CONNECTION_HTTP_CONFIRM uuid:").append(uuid).append(",")
