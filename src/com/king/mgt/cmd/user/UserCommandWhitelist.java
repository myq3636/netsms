 ...
 * @version 1.0
 */
public class UserCommandWhitelist extends UserCommand {
	private static SystemLogger log = SystemLogger
			.getSystemLogger(UserCommandWhitelist.class);
	...
	public static final String keyword = "whitelist";

	public UserCommandWhitelist() {
	...
	public SystemCommand buildSystemCommand() {
		return new SystemCommandWhitelist(this);
	}
