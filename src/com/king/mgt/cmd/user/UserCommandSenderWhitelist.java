...
import com.king.mgt.cmd.system.SystemCommandSenderWhitelist;
 ...
 * @version 1.0
 */
public class UserCommandSenderWhitelist extends UserCommand {
	private static SystemLogger log = SystemLogger
			.getSystemLogger(UserCommandSenderWhitelist.class);
	...
	public static final String keyword = "senderWL";

	public UserCommandSenderWhitelist() {
	...
	public SystemCommand buildSystemCommand() {
		return new SystemCommandSenderWhitelist(this);
	}
