...
import com.king.mgt.cmd.system.SystemCommandSenderBlacklist;
 ...
 * @version 1.0
 */
public class UserCommandSenderBlacklist extends UserCommand {
	private static SystemLogger log = SystemLogger
			.getSystemLogger(UserCommandSenderBlacklist.class);
	...
	public static final String keyword = "senderBL";

	public UserCommandSenderBlacklist() {
	...
	public SystemCommand buildSystemCommand() {
		return new SystemCommandSenderBlacklist(this);
	}
