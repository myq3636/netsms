 ...
 * @version 1.0
 */
public class UserCommandRecipientAddressRule extends UserCommand {
	private static SystemLogger log = SystemLogger
			.getSystemLogger(UserCommandRecipientAddressRule.class);
	...
	public static final String keyword = "recipientRule";

	public UserCommandRecipientAddressRule() {
	...
	public SystemCommand buildSystemCommand() {
		return new SystemCommandRecipientAddressRule(this);
	}
