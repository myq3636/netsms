 ...
 * @version 1.0
 */
public class UserCommandRecipientBlacklist extends UserCommand {
	private static SystemLogger log = SystemLogger
			.getSystemLogger(UserCommandRecipientBlacklist.class);
	...
	public static final String keyword = "recipientBL";

	public UserCommandRecipientBlacklist() {
	...
	public SystemCommand buildSystemCommand() {
		return new SystemCommandRecipientBlacklist(this);
	}
