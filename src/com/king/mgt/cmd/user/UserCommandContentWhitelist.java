...
import com.king.mgt.cmd.system.SystemCommandContentWhitelist;
 ...
 * @version 1.0
 */
public class UserCommandContentWhitelist extends UserCommand {
	private static SystemLogger log = SystemLogger
			.getSystemLogger(UserCommandContentWhitelist.class);
	...
	public static final String keyword = "contentWL";

	public UserCommandContentWhitelist() {
	...
	public SystemCommand buildSystemCommand() {
		return new SystemCommandContentWhitelist(this);
	}
