 ...
 * @version 1.0
 */
public class UserCommandVendorContentReplacement extends UserCommand {
	private static SystemLogger log = SystemLogger
			.getSystemLogger(UserCommandVendorContentReplacement.class);
	...
	public static final String keyword = "vendorContentRP";

	public UserCommandVendorContentReplacement() {
	...
	public SystemCommand buildSystemCommand() {
		return new SystemCommandVendorContentReplacementcmd(this);
	}
