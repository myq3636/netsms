 ...
 * @version 1.0
 */
public class UserCommandContentBlacklist extends UserCommand {
	private static SystemLogger log = SystemLogger
			.getSystemLogger(UserCommandContentBlacklist.class);
	...
	public static final String keyword = "contentBL";

	public UserCommandContentBlacklist() {
	...
	public SystemCommand buildSystemCommand() {
		return new SystemCommandContentBlacklist(this);
	}
