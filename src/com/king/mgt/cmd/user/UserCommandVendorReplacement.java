...
import com.king.mgt.cmd.system.SystemCommandContentBlacklist;
import com.king.mgt.cmd.system.SystemCommandRecipientAddressRule;
import com.king.mgt.cmd.system.SystemCommandRecipientBlacklist;
import com.king.mgt.cmd.system.SystemCommandVendorContentReplacementcmd;
import com.king.mgt.cmd.system.SystemCommandVendorReplacementcmd;
import com.king.mgt.cmd.system.SystemCommandWhitelist;
 ...
 * @version 1.0
 */
public class UserCommandVendorReplacement extends UserCommand {
	private static SystemLogger log = SystemLogger
			.getSystemLogger(UserCommandVendorReplacement.class);
	...
	public static final String keyword = "vendorRP";

	public UserCommandVendorReplacement() {
	...
	public SystemCommand buildSystemCommand() {
		return new SystemCommandVendorReplacementcmd(this);
	}
