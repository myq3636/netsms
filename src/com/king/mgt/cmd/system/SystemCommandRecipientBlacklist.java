...
public class SystemCommandRecipientBlacklist extends SystemCommand{
    private static SystemLogger log=SystemLogger.getSystemLogger(SystemCommandRecipientBlacklist.class);
    public static short ID=0x012;
    ...
    public SystemCommandRecipientBlacklist(UserCommandRecipientBlacklist cmd) {
        super(cmd, ID);
    }
