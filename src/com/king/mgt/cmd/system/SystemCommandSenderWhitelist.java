...
public class SystemCommandSenderWhitelist extends SystemCommand{
    private static SystemLogger log=SystemLogger.getSystemLogger(SystemCommandSenderWhitelist.class);
    public static short ID=0x00e;
    ...
    public SystemCommandSenderWhitelist(UserCommandSenderWhitelist cmd) {
        super(cmd, ID);
    }
