...
public class SystemCommandContentBlacklist extends SystemCommand{
    private static SystemLogger log=SystemLogger.getSystemLogger(SystemCommandContentBlacklist.class);
    public static short ID=0x011;
    ...
    public SystemCommandContentBlacklist(UserCommandContentBlacklist cmd) {
        super(cmd, ID);
    }
