 ...
 * @version 1.0
 */
public class SystemCommandVendorReplacementcmd extends SystemCommand{
    private static SystemLogger log=SystemLogger.getSystemLogger(SystemCommandVendorReplacementcmd.class);
    public static short ID=0x014;
    ...
    public SystemCommandVendorReplacementcmd(UserCommandVendorReplacement cmd) {
        super(cmd, ID);
    }
