...
public class SystemCommandRecipientAddressRule extends SystemCommand{
    private static SystemLogger log=SystemLogger.getSystemLogger(SystemCommandRecipientAddressRule.class);
    public static short ID=0x00d;
    ...
    public SystemCommandRecipientAddressRule(UserCommandRecipientAddressRule cmd) {
        super(cmd, ID);
    }
