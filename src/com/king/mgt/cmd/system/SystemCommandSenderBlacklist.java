...
public class SystemCommandSenderBlacklist extends SystemCommand{
    private static SystemLogger log=SystemLogger.getSystemLogger(SystemCommandSenderBlacklist.class);
    public static short ID=0x00f;
    ...
    public SystemCommandSenderBlacklist(UserCommandSenderBlacklist cmd) {
        super(cmd, ID);
    }
